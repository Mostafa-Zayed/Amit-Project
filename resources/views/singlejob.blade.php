...
<div class="unit-5 overlay" style="background-image: url('{{asset('images/hero_2.jpg')}}');">
  <div class="container text-center">
    <h2 class="mb-0">{{ucfirst($job->title)}}</h2>
    <br/>
    <p class="mb-0 unit-6"><a href="{{url('/')}}">Home</a> <span class="sep">></span><a href="{{url('/jobs')}}">Jobs</a><span class="sep"> >> </span><span>{{$job->title}}</span></p>
  </div>
</div>
    ...
    <div class="row">
          ...
          <div class="mb-4 mb-md-5 mr-5">
           <div class="job-post-item-header d-flex align-items-center">
             ...
             <div class="badge-wrap">
              <span class="border border-warning text-warning py-2 px-4 rounded">{{$job->type->name}}</span>
             </div>
           </div>
           <div class="job-post-item-body d-block d-md-flex">
             <div class="mr-3"><span class="fl-bigmug-line-portfolio23"></span> <a href="#">{{$job->location->name}}</a></div>
             <div><span class="fl-bigmug-line-big104"></span> <span>{{ucfirst($job->city)}} City, {{ucwords($job->location->icon)}}</span></div>
           </div>
          </div>
      ...
      <div class="col-lg-4">
        ...
        <div class="p-4 mb-3 bg-white">
          ...
          <p><strong>Tel : </strong> {{$job->phone}}</p>
          <p><strong>Email : </strong>Email test now</p>
        </div>
      </div>
    </div>
  </div>
