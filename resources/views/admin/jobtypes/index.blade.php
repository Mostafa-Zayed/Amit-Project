        ...
        <div class="main-panel">
            ...
            <div class="content">
                        ...
                        <div class='col-md-4'>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{url('admin/jobtypes')}}">Jobs Type</a></li>
                ...
                @endif
                                    ...
                                    <table class="table table-hover table-striped">
                                        ...
                                        @foreach($types as $type)
                                            <tr align="left">
                                                ...
                                                <td>{{ucfirst($type->icon)}}</td>
                                                <td>{{$type->created_at}}</td>
                                                <td>{{$type->updated_at}}</td>
                                                <td><a href="{{url('admin/jobtypes/'.$type->id.'/edit')}}" class='btn btn-info'>Edit</a></td>
                                                <td>
                                                    <form method='POST' action="{{url('admin/jobtypes/'.$type->id)}}" class='form-delete'>
                    ...
                    <div class="row">
                        <div class='col-md-12'>
                            <a class="btn btn-info btn-fill pull-right" href="{{url('admin/jobtypes/create')}}">Create New Type</a>
                        </div>
                    </div>
                    <br>
