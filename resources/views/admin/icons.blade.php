                        ...
                        <div class="card">
                            ...
                            <div class="content all-icons">
                                <div class="row">
                                  ...
                                  <div class="font-icon-list col-lg-2 col-md-3 col-sm-4 col-xs-6 col-xs-6">
                                    <div class="font-icon-detail"><i class="pe-7s-culture3"></i>
                                      <input type="text" value="pe-7s-culture3">
                                    </div>

                                  </div>
                                  <div class="font-icon-list col-lg-2 col-md-3 col-sm-4 col-xs-6 col-xs-6">
                                    <div class="font-icon-detail"><i class="pe-7s-culture2"></i>
                                      <input type="text" value="pe-7s-culture2">
                                    </div>

                                  </div>
                                  <div class="font-icon-list col-lg-2 col-md-3 col-sm-4 col-xs-6 col-xs-6">
                                    <div class="font-icon-detail"><i class="pe-7s-culture1"></i>
                                      <input type="text" value="pe-7s-culture1">
                                    </div>
