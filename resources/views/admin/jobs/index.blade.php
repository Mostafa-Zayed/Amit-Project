    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
                                ...
                                <table class="table table-hover table-striped ">
                                    ...
                                    @foreach($jobs as $job)
                                        <tr align="center">
                                            <td>{{$job->id}}</td>
                                            <td>{{$job->title}}</td>
                                            <td><a href="{{url('admin/users/'.$job->user->id)}}">{{$job->user->name}}</a></td>
                                            <td>{{$job->category->name}}</td>
                                            <td>{{$job->type->name}}</td>
                                            <td>{{$job->location->name}}</td>
                                            <td><a href="{{url('admin/jobs/'.$job->id.'/edit')}}" class='btn btn-info'>Show / Edit</a></td>
                                            <td>
                                                <form method='POST' class='form-delete' action="{{url('admin/jobs/'.$job->id)}}">
                ...
                <div class="row">
                    <div class='col-md-12'>
                    <a class="btn btn-info btn-fill pull-right" href="{{url('admin/jobs/create')}}">Create New Job</a>
                    </div>
                </div>
                <br>
                <!--<div class="row">
