    ...
    <div class="main-panel">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-left">
                        <li>
                            <a href="{{url('dashboard/jobs/'.auth()->user()->id)}}" class="dropdown-toggle" data-toggle="dropdown">
        ...
        <div class="content">
            <div class="container-fluid">
                                ...
                                <table class="table table-hover table-striped ">
                                    ...
                                    @foreach($jobs as $job)
                                        <tr align="center">
                                            ...
                                            <td><a href="{{url('dashboard/'.$job->id.'/edit')}}" class='btn btn-info'>Show / Edit</a></td>
                                            <td>
                                                <form method='POST' class='form-delete' action="{{url('dashboard/'.$job->id)}}">
                ...
                <div class="row">
                    <div class='col-md-12'>
                    <a class="btn btn-info btn-fill pull-right" href="{{url('dashboard/create')}}">Create New Job</a>
                    </div>
                </div>
                <br>
